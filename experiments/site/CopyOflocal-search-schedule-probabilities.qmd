...
class Schedule:
    def __init__(self, x, d, s, q, v0):
        ...
        self.parameters = {'x': x, 'd': d, 's': s, 'q': q, 'v0': v0}
    ...
    def _initialize_system(self):
        ...
        """The total distribution of work in the system just before the arrival of scheduled patients in state t is the convolution of p_min with the distribution of work generated by emergency patients"""
        print("emergency")
        self.system['p_min'][0] = np.convolve(self.parameters['v0'], self.system['p_min'][0], mode='valid')
        print(self.system['p_min'][0])
    ...
    def _calculate_state(self):
        ...
        # self.system['p_min'][self.state] = np.convolve(self.system['p_min'][self.state], self.parameters['v0'])
...
```{python}
def run_schedule(x, d, s, q, v0, u=1, omega=0.3, print_system=True):
    file_to_clear = open("logs.txt",'w')
    file_to_clear.close()
    schedule = Schedule(x=x, d=d, s=s, q=q, v0=v0)
...
v0 = calculate_rolling_convolution(p_y, se)
```
...
u = 5
omega = 0.5
sch = run_schedule(x, d, s, q, v0, u, omega, False)
