...
-   [x] Implement common random number option in client generator
...
def generate_logn_sts(s, n, mu, sd):
  sts = np.random.lognormal(mean = logn_mean_sd(mu, sd)[0], sigma=logn_mean_sd(mu, sd)[1], size=s * n)
...
```{python}
sts = generate_logn_sts(1, 1000, 14, 5)[0]
...
sts = generate_logn_sts(1, 1000, 14, 10)[0]
