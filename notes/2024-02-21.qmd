...
fig.add_trace(go.Scatter(x=list(n_values), y=two_to_the_n_values, mode='lines+markers', name='$2^{n^2}$'))

# Add titles and labels
fig.update_layout(title='Mathematical Functions Visualization',
                  xaxis_title='n',
                  yaxis_title='Value',
