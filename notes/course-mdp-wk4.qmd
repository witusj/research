...
The transition probability $T$ from state $r$ to state $r'$ is the probability that $r'$ booked reservations remain after the hour, given that there are $r$ booked reservations at the beginning of the hour. It can be divided up in two separate transition probabilities $Q$ and $P$ with:
