...
::: {.column width="40%"}
::: {style="padding: 35px;"}
<canvas id="condProb" width="500" height="500" style="border:1px solid #d3d3d3;">
...
ctx.scale(0.4, 1);
ctx.beginPath();
ctx.arc(500, 250, 180, 0, 2 * Math.PI);
ctx.closePath();
ctx.fillStyle = 'skyblue';
ctx.fill();
ctx.stroke();
...
ctx.scale(0.7, 1);
ctx.beginPath();
ctx.arc(1400, 250, 180, 0, 2 * Math.PI);
ctx.closePath();
ctx.fillStyle = 'skyblue';
ctx.fill();
ctx.stroke();
...
ctx.globalAlpha = 0.2;
ctx.fillStyle = 'red';
ctx.fillRect(180, 250, 320, 250);
ctx.restore();

ctx.lineWidth=3;
ctx.strokeStyle="black";
ctx.strokeRect(179, 249, 321, 251);
