...
fig = px.scatter(x=sample_points[:, 0], y=sample_points[:, 1], color= objective_values, labels={'x': 'Integer Variable', 'y': 'Continuous Variable'}, title='Distribution of Sample Points in Design Space', color_continuous_scale='deep')
